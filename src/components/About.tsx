  ...
  return (
    <section className="about-section section-shell" id="about">
      ...
      <div className="about-copy">
        ...
        <h2>A social specialist who thinks across <em>brand, product, and operations.</em></h2>
        ...
        <p>I have worked remotely with international teams, collaborated directly with founders, and built LeLe Linen from the owner’s side. That mix made me comfortable moving between strategy and execution, without waiting for perfect inputs or a large team.</p>
